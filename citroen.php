<?php
    $xml = simplexml_load_file('citroen.xml');
?>
                        ...
                        <div id="carouselExampleControls" class="carousel" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="oglas2/citroen1.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas2/citroen2.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas2/citroen3.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas2/citroen4.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas2/citroen5.jpg" alt="">
                                </div>
                            </div>
