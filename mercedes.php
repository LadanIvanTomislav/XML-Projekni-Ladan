<?php
    $xml = simplexml_load_file('mercedes.xml');
?>
                        ...
                        <div id="carouselExampleControls" class="carousel" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="oglas4/mercedes1.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas4/mercedes2.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas4/mercedes3.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas4/mercedes4.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas4/mercedes5.jpg" alt="">
                                </div>
                            </div>
