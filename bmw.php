<?php
    $xml = simplexml_load_file('bmw.xml');
?>
                        ...
                        <div id="carouselExampleControls" class="carousel" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="oglas3/bmw1.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas3/bmw2.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas3/bmw3.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas3/bmw4.jpg" alt="">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="oglas3/bmw5.jpg" alt="">
                                </div>
                            </div>
